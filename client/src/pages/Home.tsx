...
import { CalendarDays, Check, ChevronDown, Clock3, Facebook, Layers3, Menu, MessageCircle, MoveUpRight, Phone, ShieldCheck, Sparkles, X, Zap } from "lucide-react";
...
export default function Home() {
  ...
  return <div className="site-shell">
    ...
    <main>
      ...
      <section id="contact" className="contact-section container"><div><p className="eyebrow">READY TO SIMPLIFY?</p><h2>Let's make your<br /><em>next move smarter.</em></h2></div><div className="contact-card"><p>Tell us about your business and we will recommend the right software and automation for your growth.</p><button className="primary-button" onClick={() => setBookingOpen(true)}>Tell us about your business <MoveUpRight size={17} /></button><div className="contact-meta"><span><Phone size={14} /> Cairo, Egypt</span><span><MessageCircle size={14} /> WhatsApp notifications</span></div></div></section>
    </main>
    <footer className="footer container"><a className="brand" href="#home"><span className="brand-mark">+</span><span>Take<span>More</span></span></a><p>Smart Business Solutions — Helping businesses simplify operations & grow smarter.</p><div className="footer-links"><a href="https://www.facebook.com/profile.php?id=61593829229146" target="_blank" rel="noreferrer"><Facebook size={16} /> Follow us</a><Link href="/admin">Admin</Link></div></footer>
